  ...
  render() {
    return (
      <>
        ...
        <p className='text-center'>componentDidMount after <strong>"3-seconds"</strong> "Black"</p>
        ...
        <code className='text-dark'>
          ...
          &nbsp;&nbsp;setTimeout(() =&gt; &#123; <br />
          &nbsp;&nbsp;&nbsp;this.setState(&#123; favoritecolor: "Black" &#125;) <br />
          &nbsp;&nbsp;&#125;, 3000) <br />
          &#125; <br />
          render() &#123; <br />
          &nbsp;&nbsp; return ( <br />
          ...
          &nbsp;&nbsp;&nbsp; &lt;p className='text-center'&gt;componentDidMount after &lt;strong&gt;"3-seconds"&lt;/strong&gt; "Black"&lt;/p&gt; <br />
