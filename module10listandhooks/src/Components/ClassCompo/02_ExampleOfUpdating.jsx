...
class ExampleOfUpdating extends Component {
    constructor(props) {
        super(props);
        this.state = { favoriteFood: 'Mexican' };
    }
    ...
    changeFood = () => {
        this.setState({ favoriteFood: 'Italian' });
    }
        ...
        return (
            <>
                <div>
                    ...
                    <p className='text-center'>ComponentUpdate after <strong>"click"</strong> on button</p>
